...
motor right_chassis2 = motor(PORT7, ratio6_1, false);
...
rotation horizontal_tracker = rotation(PORT4, false);
rotation vertical_tracker = rotation(PORT5, false);
...
double wheel_distance_in = (48.0 / 60.0) * 3.17 * M_PI;
